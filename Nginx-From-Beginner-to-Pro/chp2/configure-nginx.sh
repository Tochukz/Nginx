#!/bin/bash
# Filename: configure-nginx.sh
# Description: Configure Nginx to prepare for subsequent installation from source
sourceDir=~/nginx-1.18.0

export BUILD_DIR=$sourceDir
